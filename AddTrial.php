	...
	<div class="try">
		<div id="Trial_details">
			<table>
				...
				<tr><th>Objective</th><td><input required class="w3-input" type="textbox" id="objective" name="obj"></td></tr>
				<tr><th>Start date</th><td><input required class="w3-input" type="date" id="start_date" name="p1"></td></tr>
				...
				<tr><th>Number of Patients</th><td><input required class="w3-input" type="textbox" id="Patient_no" name="pat1"></td></tr>
			</table>
		<div id="side_effects">
			<table>
				
				<tr><th colspan="2">POSSIBLE SIDE EFFECTS</th></tr>
				<tr><th>HEADACHE</th><td><input required class="w3-input" type="textbox" id="headache" name="e1" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>STOMACHACHE</th><td><input required class="w3-input" type="textbox" id="stomachache" name="e2" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>NAUSEA</th><td><input required class="w3-input" type="textbox" id="nausea" name="e3" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>CONSTIPATION</th><td><input required class="w3-input" type="textbox" id="constipation" name="e4" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>INSOMNIA</th><td><input required class="w3-input" type="textbox" id="insomnia" name="e5" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>FEVER</th><td><input required class="w3-input" type="textbox" id="fever" name="e6" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>DIARROHEA</th><td><input required class="w3-input" type="textbox" id="diarrohea" name="e7" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>FOOD APPETITE</th><td><input required class="w3-input" type="textbox" id="food_appetite" name="e8" placeholder="(0:NO 1:YES)"></td></tr>
				<tr><th>ANXIETY</th><td><input required class="w3-input" type="textbox" id="anxiety" name="e9" placeholder="(0:NO 1:YES)"></td></tr>
