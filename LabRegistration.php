...
<body style="background-color: #fff8f5; overflow: scroll;">
		...
		<button style="margin-bottom: 20px; " class="w3-center w3-button w3-col s4 w3-bar-item w3-button w3-blue w3-round-xxlarge  w3-hover-shadow w3-hover-blue w3-text-black" id="Addtrial" onclick="Register('Lab')" style="width:100px;">Submit</button>
</body>
</html>